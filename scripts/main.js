...
const tocaAudio = document.getElementById('audio-notif')
...
btn_iniciar_simul.addEventListener("click",(evt)=>{
    tocaAudio.src = tracks[0]
    tocaAudio.play()
    tmpini = Date.now()
...
function calcularTE() {
    if (minutoglobal >= INTERACAO_LIMITE) {
